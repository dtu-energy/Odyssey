...
from odyssey.navigators.botorch_single_objective import BOTorch_SingleGP_Navigator # Navigator
...
def main():
    ...
    # set up navigator
    navigator = BOTorch_SingleGP_Navigator(
        mission = mission,
    ...
    while len(mission.train_X) < args.iterations:
        params = navigator.get_next_trial(q=2)
